const PLATFORMS: Record<string, { label: string; bg: string; icon: React.ReactNode }> = {
  x: {
    label: "X",
    bg: "#111111",
    icon: (
...
export default function BroadcastBadges({ platforms }: { platforms: string[] }) {
  if (!platforms || platforms.length === 0) return null;
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 4, flexWrap: "wrap" }}>
      <span style={{ fontSize: 10, color: "var(--text-muted)" }}>Also posted to:</span>
      {platforms.map(p => {
