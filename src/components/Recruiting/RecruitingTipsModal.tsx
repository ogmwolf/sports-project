...
export default function RecruitingTipsModal({ open, onClose }: Props) {
  return (
    <Modal open={open} onClose={onClose} title="Recruiting tips" subtitle="How to stay on coaches' radar">
